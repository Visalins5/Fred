...
fred = Fred(api_key='830d79b062f7d3f61b27d823ee58ead1')
series_id = 'PAYEMS'
...
try:
    ...
    # Truncate the table to remove existing data and avoid duplicate key errors
    cursor.execute("TRUNCATE TABLE nonfarm_payrolls;")
    conn.commit()
